...
class SimpleConvNet(nn.Module):
	...
	def forward(self, input):
		...
		output = F.max_pool2d(self.relu(self.conv1(input)), (2, 2))
		output = F.max_pool2d(self.relu(self.conv2(output)), (2, 2))
		output = F.max_pool2d(self.relu(self.conv3(output)), (2, 2))
		output = F.max_pool2d(self.relu(self.conv4(output)), (2, 2))
